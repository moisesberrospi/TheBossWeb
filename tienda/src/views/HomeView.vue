  ...
  <div class="home">
    <section>
      ...
      <div class="owl-carousel owl-theme owl-dots-modern home-slider">
        ...
        <div class="item d-flex align-items-center bg-dark dark-overlay"><img class="bg-image" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/photo/ian-dooley-347942-unsplash.jpg" alt="">
          <div class="container py-6">
            <div class="row">
        ...
        <div class="item d-flex align-items-center"><img class="bg-image" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/photo/haley-phelps-62815-unsplash.jpg" alt="">
          <div class="container py-6">
            <div class="row">
              <div class="col-lg-8 col-xl-6 mx-auto text-white text-center position-relative">
      ...
      <div class="container py-6">
        ...
        <div class="row align-items-md-stretch">
          <div class="col-lg-4 d-flex align-items-lg-stretch position-relative">
            <div class="d-flex align-items-center text-white border-0 w-100 py-6 py-lg-4 text-center mb-4 mb-lg-0" style="background: center center url(https://d19m59y37dris4.cloudfront.net/sell/2-0/img/photo/rahul-anil-214671-unsplash.jpg) no-repeat; background-size: cover;"><a class="tile-link" href="category.html"> </a>
              <div class="w-100">
          ...
          <div class="col-lg-8">
            <div class="card light-overlay position-relative text-dark border-0 mb-4"><img class="card-img" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/photo/pete-bellis-189599-unsplash.jpg" alt="Card image"><a class="tile-link" href="category.html"> </a>
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="card text-white position-relative border-0 mb-lg-0 mb-4"><img class="card-img" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/photo/haley-phelps-62815-unsplash.jpg" alt="Card image"><a class="tile-link" href="category.html"> </a>
                  <div class="card-img-overlay d-flex align-items-center">
              ...
              <div class="col-lg-4">
                <div class="card position-relative dark-overlay text-white border-0 mb-lg-0 mb-4"><img class="card-img" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/photo/matese-fields-233175-unsplash.jpg" alt="Card image"><a class="tile-link" href="category.html"> </a>
                  <div class="card-img-overlay d-flex align-items-center">
                    <div class="text-center w-100 overlay-content">
              ...
              <div class="col-lg-4">
                <div class="card position-relative text-white border-0"><img class="card-img" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/photo/brooke-cagle-195856-unsplash.jpg" alt="Card image"><a class="tile-link" href="category.html"> </a>
                  <div class="card-img-overlay d-flex align-items-center">
                    <div class="text-center w-100">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-6">
            <div class="mb-4"><a href="post.html"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/photo/kyle-loftus-596319-unsplash.jpg" alt="..."></a>
          ...
          <!-- post-->
          <div class="col-lg-4 col-6">
            <div class="mb-4"><a href="post.html"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/photo/marion-michele-330691-unsplash.jpg" alt="..."></a>
              <div class="mt-3"><small class="text-uppercase text-muted">Fashion and style </small>
          ...
          <!-- post-->
          <div class="col-lg-4 col-6">
            <div class="mb-4"><a href="post.html"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/photo/kyle-loftus-589739-unsplash-cropped.jpg" alt="..."></a>
              <div class="mt-3"><small class="text-uppercase text-muted">Fashion and style </small>
                <h5 class="my-2"><a class="text-dark" href="post.html">Best books about Fashion          </a></h5>
                <p class="text-gray-500 text-sm my-3"><i class="far fa-clock me-2"></i>January 16, 2016</p>
    ...
    <!-- Divider Section-->
    <section class="py-6 position-relative light-overlay"><img class="bg-image" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/photo/benjamin-voros-260869-unsplash.jpg" alt="">
      <div class="container">
    ...
    <section class="py-6 brands">
      <div class="container">
        <h4 class="text-uppercase text-center mb-5">Our brands</h4>
        <!-- Brands Slider-->
        <div class="owl-carousel owl-theme brands-slider">
          <!-- item-->
          <div class="item d-flex align-items-center justify-content-center">
            <div class="w-6rem"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/brand/brand-1.svg" alt="Brand 1"></div>
          </div>
          <!-- item-->
          <div class="item d-flex align-items-center justify-content-center">
            <div class="w-6rem"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/brand/brand-2.svg" alt="Brand 2"></div>
          </div>
          <!-- item-->
          <div class="item d-flex align-items-center justify-content-center">
            <div class="w-6rem"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/brand/brand-3.svg" alt="Brand 3"></div>
          </div>
          <!-- item-->
          <div class="item d-flex align-items-center justify-content-center">
            <div class="w-6rem"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/brand/brand-4.svg" alt="Brand 4"></div>
          </div>
          <!-- item-->
          <div class="item d-flex align-items-center justify-content-center">
            <div class="w-6rem"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/brand/brand-5.svg" alt="Brand 5"></div>
          </div>
          <!-- item-->
          <div class="item d-flex align-items-center justify-content-center">
            <div class="w-6rem"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/brand/brand-6.svg" alt="Brand 6"></div>
          </div>
          <!-- item-->
          <div class="item d-flex align-items-center justify-content-center">
            <div class="w-6rem"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/brand/brand-1.svg" alt="Brand 1"></div>
